package com.coding.guide.admin.config;
...
public class Swagger3Configuration {
  ...
  public Docket createRestApi(){
    ...
    return new Docket(DocumentationType.OAS_30)
            ...
            .select()
            //扫描的路径包
            .apis(RequestHandlerSelectors.basePackage("com.coding.guide.admin.controller"))
  ...
  private ApiInfo apiInfo(){
    return new ApiInfoBuilder()
            .title("coding-guide-admin的接口文档")
            .description("coding-guide-admin的接口文档")
            // 本API负责人的联系信息
